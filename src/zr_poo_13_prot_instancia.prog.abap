REPORT ZR_POO_13_PROT_INSTANCIA.
...
**********************************************************************
" Create Private: encapsula a instância da classe
CLASS lcl_descricao_material DEFINITION CREATE PRIVATE.
  PUBLIC SECTION.
  " incluído
    CLASS-METHODS:
    " Encapsula a criação. Centraliza num mesmo lugar a criação
    " Facilita o rastreamento de onde a instância é criada
